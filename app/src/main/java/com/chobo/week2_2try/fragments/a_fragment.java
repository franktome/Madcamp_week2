        ...
        result.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                if(current_seat==null){
                    ...
                    OkHttpClient client = new OkHttpClient();
                    String jsonData = String.format("{\"start_time\": \"%s\", \"end_time\": \"%s\", \"room\": \"A\", \"seat_no\": \"%s\", \"user_id\": \"%s\" }",start_time,end_time,current_seat_no, user_id);
                    RequestBody formBody = RequestBody.create(MediaType.parse("application/json"), jsonData);
                    Request request = new Request.Builder()
